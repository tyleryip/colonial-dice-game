    ...
    return (
        ...
        >
            ...
            <StyledHowToPlayModalBody>
                ...
                <StyledHowToPlayAsset src={fresh_game_png} />
                <h1>
                    Setup
                </h1>
                <p>
                ...
                <StyledHowToPlayAsset src={toggle_dice_locks_gif} />
                <h2>
                    Building
                </h2>
                <p>
                ...
                <StyledHowToPlayAsset src={hover_to_see_cost_gif} />
                <p>
                ...
                <StyledHowToPlayAsset src={use_knight_to_set_resource_gif} />
                <p>
                    The wildcard joker lets you choose which resource to set.
                </p>
                <StyledHowToPlayAsset src={use_wildcard_joker_to_choose_resource_gif} />
                <p>
                ...
                <StyledHowToPlayAsset src={trade_gold_for_any_resource_gif} />
                <h1>
                    Scoring
                </h1>
                <p>
                ...
                <StyledHowToPlayAsset src={game_over_png} />
            </StyledHowToPlayModalBody>
        </Modal>
    )
}
